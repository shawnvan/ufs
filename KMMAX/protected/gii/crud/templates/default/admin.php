	...
	<?php echo "<?php"; ?>
        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Manage <?php echo $this->modelClass; ?>'),'linkOptions'=>array('class'=>'current') ,'url'=>array('admin'),'visible'=>Yii::app()->user->checkAccess('<?php echo $this->ModuleID; ?>.<?php echo $this->ControllerID; ?>.Admin')),					
                    ),
                ));
    ?>
	</div>
