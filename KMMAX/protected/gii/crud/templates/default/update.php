	...
	<?php echo "<?php"; ?>
        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Update <?php echo $this->modelClass; ?>'),'linkOptions'=>array('class'=>'current'), 'id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('<?php echo $this->ModuleID; ?>.<?php echo $this->ControllerID; ?>.Update')),
