...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Update'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fUserID,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('users.user.Update')),
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
         ...
         <?php echo $form->hiddenField($model,'fUserID',array('size'=>50,'maxlength'=>50)); ?>
