...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy Profile'),'linkOptions'=>array('class'=>'current'),  'id'=>$model->fUserID,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('users.profile.Copy')),
						array('label'=>Yii::t('label','Update Profile'), 'id'=>$model->fUserID,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('users.profile.Update')),
