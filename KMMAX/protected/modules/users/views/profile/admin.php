...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Manage Profile'),'linkOptions'=>array('class'=>'current') ,'url'=>array('admin'),'visible'=>Yii::app()->user->checkAccess('users.profile.Admin')),					
                    ),
                ));
    ?>
	</div>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		'fEmailSignature',
		'fEnableFullWidth',
		'fSyncGoogleCalendarId',
		'fSyncGoogleCalendarAccessToken',
		'fSyncGoogleCalendarRefreshToken',
		'fGoogleId',
		'fUserCalendarsVisible',
		'fGroupCalendarsVisible',
		'fTagsShowAllUsers',
		'fWidgets',
		'fAllowPost',
		'fBackgroundColor',
