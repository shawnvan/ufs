...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'htmlOptions'=>array('class'=>'vertical-form'),
		...
		<div class="input-group">
          <?php echo $form->label($model,'fPlanNo'); ?>
		...
		<div class="input-group">
          <?php echo $form->label($model,'fTitle'); ?>
		...
		<div class="input-group">
          <?php echo $form->label($model,'fMonth'); ?>
		...
		<div class="input-group">
          <?php echo $form->label($model,'fUpPlan'); ?>
		...
		<div class="input-group">
          <?php echo $form->label($model,'fNowPlan'); ?>
