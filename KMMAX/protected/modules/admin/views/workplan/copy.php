...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy Workplan'),'linkOptions'=>array('class'=>'current'),  'id'=>$model->fPlanNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('admin.workplan.Copy')),
