...
$this->breadcrumbs=array(
	...
	$model->fOrgNo=>array('view','id'=>$model->fOrgNo),
	'Update',
);
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy Companyorganisation'),'linkOptions'=>array('class'=>'current'),  'id'=>$model->fOrgNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('admin.companyorganisation.Copy')),
