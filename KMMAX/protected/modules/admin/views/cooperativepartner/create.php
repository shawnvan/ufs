...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Create'), 'url'=>array('create'),'linkOptions'=>array('class'=>'current'),'visible'=>Yii::app()->user->checkAccess('admin.cooperativepartner.Create')),					
	...
	<?php echo $form->errorSummary($model); ?>
	  <div class="input-group">
          ...
          <?php echo $form->textField($model,'fCooperativeCompanyID',array('size'=>50,'maxlength'=>50)); ?>
           <?php echo CHtml::hiddenField('fCooperativeCompanyID','fCooperativeCompanyID',array('size'=>50,'maxlength'=>50,'class'=>'required')); ?>
