...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('cooperativecompany-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Manage'),'linkOptions'=>array('class'=>'current') ,'url'=>array('admin'),'visible'=>Yii::app()->user->checkAccess('admin.cooperativecompany.Admin')),					
                    ),
                ));
    ?>
	</div>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		'fCooperativeCompanyName',
		'fCooperativeCompanyShortName',
		'fStarLevel',
		'fType',
		'fKeyContacts',
		/*
