...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy'),'linkOptions'=>array('class'=>'current'),  'id'=>$model->fCooperativeCompanyID,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('admin.cooperativecompany.Copy')),
