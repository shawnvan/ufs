...
$this->breadcrumbs=array(
	'Users'=>array('index'),
	$model->fCooperativeCompanyID=>array('view','id'=>$model->fCooperativeCompanyID),
	'Update',
);
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
                		array('label'=>Yii::t('label','List表'), 'url'=>array('grid'),'visible'=>Yii::app()->user->checkAccess('admin.Cooperativecompany.grid')),
						array('label'=>Yii::t('label','Create'), 'url'=>array('create'),'visible'=>Yii::app()->user->checkAccess('admin.Cooperativecompany.Create')),					
						array('label'=>Yii::t('label','Update'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fCooperativeCompanyID,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('admin.Cooperativecompany.Update')),
