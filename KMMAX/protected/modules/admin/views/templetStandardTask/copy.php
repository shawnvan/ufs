...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy Templetstandardtask'),'linkOptions'=>array('class'=>'current'),  'id'=>$model->fTaskNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('admin.templetstandardtask.Copy')),
