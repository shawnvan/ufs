...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
                		array('label'=>Yii::t('label','List'), 'url'=>array('index'),'visible'=>Yii::app()->user->checkAccess('report.workplan.Index')),
						array('label'=>Yii::t('label','Create'), 'url'=>array('create'),'visible'=>Yii::app()->user->checkAccess('report.workplan.Create')),					
						array('label'=>Yii::t('label','Copy'), 'linkOptions'=>array('id'=>'CopyWorkplan'),'id'=>$model->fPlanNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('report.workplan.Copy')),
						array('label'=>Yii::t('label','Update'),'linkOptions'=>array('id'=>'UpdateWorkplan'),'id'=>$model->fPlanNo,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('report.workplan.Update')),
						array('label'=>Yii::t('label','View'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fPlanNo,'url'=>array('view'),'visible'=>Yii::app()->user->checkAccess('report.workplan.View')),
						array('label'=>Yii::t('label','Manage'), 'url'=>array('admin'),'visible'=>Yii::app()->user->checkAccess('report.workplan.Admin')),					
                    ),
                ));
    ?>
	</div>
