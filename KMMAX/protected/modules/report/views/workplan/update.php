...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
                		array('label'=>Yii::t('label','List Workplan'), 'url'=>array('index'),'visible'=>Yii::app()->user->checkAccess('report.workplan.Index')),
						array('label'=>Yii::t('label','Create Workplan'), 'url'=>array('create'),'visible'=>Yii::app()->user->checkAccess('report.workplan.Create')),					
						array('label'=>Yii::t('label','Update Workplan'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fPlanNo,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('report.workplan.Update')),
						array('label'=>Yii::t('label','Manage Workplan'), 'url'=>array('admin'),'visible'=>Yii::app()->user->checkAccess('report.workplan.Admin')),					
                    ),
                ));
    ?>
	</div>
