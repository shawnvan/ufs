...
<div class="content-head underline">
	<h2><?php echo Yii::t('label','Workplans') ?></h2>
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
                		array('label'=>Yii::t('label','List'), 'url'=>array('index'),'linkOptions'=>array('class'=>'current'),'visible'=>Yii::app()->user->checkAccess('report.workplan.Index')),
...
<?php     $this->widget('application.modules.UFSBase.utils.WGrid',array(
       ...
       'sortname'=>'fPlanNo',
        'sortorder'=>'asc',
        'url'=>Yii::app()->createUrl('report/workplan/gridData',$_GET),
        'modulename'=>'Workplan',
    )); ?>
</div>