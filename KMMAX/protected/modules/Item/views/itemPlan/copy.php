...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy Itemplan'),'linkOptions'=>array('class'=>'current'),  'id'=>$model->fItemNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('Item.itemplan.Copy')),
