...
$this->breadcrumbs=array(
	...
	$model->fCalendarNo=>array('view','id'=>$model->fCalendarNo),
	'Update',
);
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Create Calendar'), 'url'=>array('create'),'visible'=>Yii::app()->user->checkAccess('Item.calendar.Create')),					
						array('label'=>Yii::t('label','Update Calendar'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fCalendarNo,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('Item.calendar.Update')),
