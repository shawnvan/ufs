...
$('#CopyCalendar').attr('href',$('#CopyCalendar').attr('href')+'/id/".$keyid."');
$('#UpdateCalendar').attr('href',$('#UpdateCalendar').attr('href')+'/id/".$keyid."');
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
                		array('label'=>Yii::t('label','List'), 'url'=>array('index'),'visible'=>Yii::app()->user->checkAccess('Item.calendar.Index')),
						array('label'=>Yii::t('label','Create'), 'url'=>array('create'),'visible'=>Yii::app()->user->checkAccess('Item.calendar.Create')),					
						array('label'=>Yii::t('label','Copy'), 'linkOptions'=>array('id'=>'CopyCalendar'),'id'=>$model->fCalendarNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('Item.calendar.Copy')),
						array('label'=>Yii::t('label','Update'),'linkOptions'=>array('id'=>'UpdateCalendar'),'id'=>$model->fCalendarNo,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('Item.calendar.Update')),
						array('label'=>Yii::t('label','View'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fCalendarNo,'url'=>array('view'),'visible'=>Yii::app()->user->checkAccess('Item.calendar.View')),
						array('label'=>Yii::t('label','Manage'), 'url'=>array('admin'),'visible'=>Yii::app()->user->checkAccess('Item.calendar.Admin')),					
                    ),
                ));
    ?>
	</div>
