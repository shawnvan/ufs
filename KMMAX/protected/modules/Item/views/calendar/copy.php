...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy Calendar'),'linkOptions'=>array('class'=>'current'),  'id'=>$model->fCalendarNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('Item.calendar.Copy')),
