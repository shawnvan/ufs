...
$('#CopyFinanceaccounting').attr('href',$('#CopyFinanceaccounting').attr('href')+'/id/".$keyid."');
$('#UpdateFinanceaccounting').attr('href',$('#UpdateFinanceaccounting').attr('href')+'/id/".$keyid."');
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
                		array('label'=>Yii::t('label','List'), 'url'=>array('index'),'visible'=>Yii::app()->user->checkAccess('Item.financeaccounting.Index')),
						array('label'=>Yii::t('label','Create'), 'url'=>array('create'),'visible'=>Yii::app()->user->checkAccess('Item.financeaccounting.Create')),					
						array('label'=>Yii::t('label','Copy'), 'linkOptions'=>array('id'=>'CopyFinanceaccounting'),'id'=>$model->fItemNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('Item.financeaccounting.Copy')),
						array('label'=>Yii::t('label','Update'),'linkOptions'=>array('id'=>'UpdateFinanceaccounting'),'id'=>$model->fItemNo,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('Item.financeaccounting.Update')),
						array('label'=>Yii::t('label','View'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fItemNo,'url'=>array('view'),'visible'=>Yii::app()->user->checkAccess('Item.financeaccounting.View')),
						array('label'=>Yii::t('label','Manage'), 'url'=>array('admin'),'visible'=>Yii::app()->user->checkAccess('Item.financeaccounting.Admin')),					
                    ),
                ));
    ?>
	</div>
