...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Update LatestStockStructure'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fHistoryNo,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('Item.latestStockStructure.Update')),
