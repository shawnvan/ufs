...
$this->menu=array(
	array('label'=>'List LatestStockStructure', 'url'=>array('index')),
	array('label'=>'Create LatestStockStructure', 'url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('latest-stock-structure-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Manage LatestStockStructure'),'linkOptions'=>array('class'=>'current') ,'url'=>array('admin'),'visible'=>Yii::app()->user->checkAccess('Item.latestStockStructure.Admin')),					
                    ),
                ));
    ?>
	</div>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'latest-stock-structure-grid',
