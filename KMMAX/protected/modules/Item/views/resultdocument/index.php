...
<input type="hidden" value="" id="treeid" name="hiddenpkey" />
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Create'), 'url'=>array('resultdocument/create/id/'.$keyid),'visible'=>Yii::app()->user->checkAccess('Item.resultdocument.Create')),					
...
<?php $this->renderPartial('_search',array(
 ...
 <ul id="treeDemo" class="tree el-finder-tree"></ul>
     ...
     $this->widget('application.modules.UFSBase.utils.WGrid',array(
       ...
       'sortname'=>'fTaskNo',
        'sortorder'=>'asc',
        'url'=>Yii::app()->createUrl('Item/resultdocument/gridData',$_GET),
