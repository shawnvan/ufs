...
$('#ListDoc').attr('href',$('#ListDoc').attr('href')+'/id/".$itemno."');	
...
<h2><?php echo Yii::t('label','Documents')?></h2>
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
                		array('label'=>Yii::t('label','List'), 'url'=>array('index'),'linkOptions'=>array('id'=>'ListDoc'),'visible'=>Yii::app()->user->checkAccess('Item.resultdocument.Index')),
