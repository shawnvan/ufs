...
$('#CopyItemcatalogueCopy').attr('href',$('#CopyItemcatalogueCopy').attr('href')+'/id/".$keyid."');
$('#UpdateItemcatalogueCopy').attr('href',$('#UpdateItemcatalogueCopy').attr('href')+'/id/".$keyid."');
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
                		array('label'=>Yii::t('label','List'), 'url'=>array('index'),'visible'=>Yii::app()->user->checkAccess('Item.itemcatalogueCopy.Index')),
						array('label'=>Yii::t('label','Create'), 'url'=>array('create'),'visible'=>Yii::app()->user->checkAccess('Item.itemcatalogueCopy.Create')),					
						array('label'=>Yii::t('label','Copy'), 'linkOptions'=>array('id'=>'CopyItemcatalogueCopy'),'id'=>$model->fCatalogueNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('Item.itemcatalogueCopy.Copy')),
						array('label'=>Yii::t('label','Update'),'linkOptions'=>array('id'=>'UpdateItemcatalogueCopy'),'id'=>$model->fCatalogueNo,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('Item.itemcatalogueCopy.Update')),
						array('label'=>Yii::t('label','View'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fCatalogueNo,'url'=>array('view'),'visible'=>Yii::app()->user->checkAccess('Item.itemcatalogueCopy.View')),
						array('label'=>Yii::t('label','Manage'), 'url'=>array('admin'),'visible'=>Yii::app()->user->checkAccess('Item.itemcatalogueCopy.Admin')),					
                    ),
                ));
    ?>
	</div>
