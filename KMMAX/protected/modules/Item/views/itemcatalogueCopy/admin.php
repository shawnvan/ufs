...
$this->menu=array(
	array('label'=>'List ItemcatalogueCopy', 'url'=>array('index')),
	array('label'=>'Create ItemcatalogueCopy', 'url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('itemcatalogue-copy-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Manage ItemcatalogueCopy'),'linkOptions'=>array('class'=>'current') ,'url'=>array('admin'),'visible'=>Yii::app()->user->checkAccess('Item.itemcatalogueCopy.Admin')),					
                    ),
                ));
    ?>
	</div>
