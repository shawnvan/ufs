...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy History'),'linkOptions'=>array('class'=>'current'),  'id'=>$model->fHistoryNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('Item.history.Copy')),
