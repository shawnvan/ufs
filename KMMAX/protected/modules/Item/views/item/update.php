...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Update'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fItemNo,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('Item.item.Update')),
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
	  ...
	  <div class="input-group">
          ...
          <div class="inputs">
          <?php echo $form->textField($model,'fItemNum',array('size'=>50,'maxlength'=>50,'disabled'=>'disabled')); ?>
	  ...
	  <div class="input-group">
          ...
          <div class="inputs">
          <?php echo $form->textField($model,'fItemName',array('size'=>60,'maxlength'=>200,'disabled'=>'disabled')); ?>
	  ...
	  <div class="input-group">
          ...
          <div class="inputs">
          <?php echo $form->dropdownList($model,'fItemType',$fItemType,array('disabled'=>'disabled')); ?>
      ...
      <div class="input-group">
          ...
          <div class="inputs">
          <?php echo $form->textField($model,'fResponsibleCreate',array('size'=>50,'maxlength'=>50,'disabled'=>'disabled')); ?>
	  ...
	  <div class="input-group">
          ...
          <div class="inputs">
          <?php echo CHtml::textField('fTemplateName',empty($model->template)?'':$model->template->fTemplateName,array('size'=>50,'maxlength'=>50,'disabled'=>'disabled'))?>
      	</div>
      </div>
