...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'htmlOptions'=>array('class'=>'vertical-form'),
		...
		<div class="input-group">
          <?php echo $form->label($model,'fWaitFinishingNum'); ?>
		...
		<div class="input-group">
          <?php echo $form->label($model,'fFinishedNum'); ?>
		...
		<div class="input-group">
          <?php echo $form->label($model,'fResultNum'); ?>
		...
		<div class="input-group">
          <?php echo $form->label($model,'fDocumentNum'); ?>
		...
		<div class="input-group">
          <?php echo $form->label($model,'fTaskNum'); ?>
		...
		<div class="input-group">
          <?php echo $form->label($model,'fKnowledgeNum'); ?>
