...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy StockStructure'),'linkOptions'=>array('class'=>'current'),  'id'=>$model->fSSNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('Item.stockStructure.Copy')),
