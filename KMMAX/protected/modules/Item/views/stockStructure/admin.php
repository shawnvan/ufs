...
$this->menu=array(
	array('label'=>'List StockStructure', 'url'=>array('index')),
	array('label'=>'Create StockStructure', 'url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('stock-structure-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Manage StockStructure'),'linkOptions'=>array('class'=>'current') ,'url'=>array('admin'),'visible'=>Yii::app()->user->checkAccess('Item.stockStructure.Admin')),					
                    ),
                ));
    ?>
	</div>
