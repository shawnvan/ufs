...
$this->breadcrumbs=array(
	...
	$model->fSSNo=>array('view','id'=>$model->fSSNo),
	'Update',
);
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Update StockStructure'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fSSNo,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('Item.stockStructure.Update')),
