...
$('#UpdateTask').attr('href',$('#UpdateTask').attr('href')+'/id/".$model->fTaskNo."');		
$('#ViewTask').attr('href',$('#ViewTask').attr('href')+'/id/".$model->fTaskNo."');						
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','View'),'linkOptions'=>array('id'=>'ViewTask'), 'id'=>$model->fTaskNo,'url'=>array('view'),'visible'=>Yii::app()->user->checkAccess('Item.task.View')),
	...
	<?php echo $form->errorSummary($model); ?>
	 ...
	 <div class="input-group">
	  ...
	  <div class="input-group">
          ...
          <div class="inputs">
          <?php echo CHtml::textField('fCatalogueName',empty($model->knowcatalogue)?'':$model->knowcatalogue->fCatalogueName,array('size'=>50,'maxlength'=>50,'disabled'=>'disabled')); ?>
