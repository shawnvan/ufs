...
$('#CopyResultdocument').attr('href',$('#CopyResultdocument').attr('href')+'/id/".$keyid."');
$('#UpdateResultdocument').attr('href',$('#UpdateResultdocument').attr('href')+'/id/".$keyid."');
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy'), 'linkOptions'=>array('id'=>'CopyResultdocument'),'id'=>$model->fResultNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('Item.resultdocument.Copy')),
						array('label'=>Yii::t('label','Update'),'linkOptions'=>array('id'=>'UpdateResultdocument'),'id'=>$model->fResultNo,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('Item.resultdocument.Update')),
