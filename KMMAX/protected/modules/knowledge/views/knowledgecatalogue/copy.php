...
<h2><?php echo Yii::t('label','Knowledgecatalogues')?></h2>
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy'),'linkOptions'=>array('class'=>'current'),  'id'=>$model->fCatalogueNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('knowledge.knowledgecatalogue.Copy')),
