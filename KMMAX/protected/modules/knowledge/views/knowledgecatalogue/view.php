...
$('#CopyKnowledgecatalogue').attr('href',$('#CopyKnowledgecatalogue').attr('href')+'/id/".$keyid."');
$('#UpdateKnowledgecatalogue').attr('href',$('#UpdateKnowledgecatalogue').attr('href')+'/id/".$keyid."');
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy'), 'linkOptions'=>array('id'=>'CopyKnowledgecatalogue'),'id'=>$model->fCatalogueNo,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('knowledge.knowledgecatalogue.Copy')),
						array('label'=>Yii::t('label','Update'),'linkOptions'=>array('id'=>'UpdateKnowledgecatalogue'),'id'=>$model->fCatalogueNo,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('knowledge.knowledgecatalogue.Update')),
						array('label'=>Yii::t('label','View'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fCatalogueNo,'url'=>array('view'),'visible'=>Yii::app()->user->checkAccess('knowledge.knowledgecatalogue.View')),
