...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy Settings'),'linkOptions'=>array('class'=>'current'),  'id'=>$model->fName,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('settings.setting.Copy')),
