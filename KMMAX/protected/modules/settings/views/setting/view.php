...
$('#CopySettings').attr('href',$('#CopySettings').attr('href')+'/id/".$keyid."');
$('#UpdateSettings').attr('href',$('#UpdateSettings').attr('href')+'/id/".$keyid."');
...
<div class="content-head underline">
	...
	<?php        $this->widget ( 'zii.widgets.CMenu', array ('id'=>'',
                ...
                'items' =>array(
						...
						array('label'=>Yii::t('label','Copy Settings'), 'linkOptions'=>array('id'=>'CopySettings'),'id'=>$model->fName,'url'=>array('copy'),'visible'=>Yii::app()->user->checkAccess('settings.setting.Copy')),
						array('label'=>Yii::t('label','Update Settings'),'linkOptions'=>array('id'=>'UpdateSettings'),'id'=>$model->fName,'url'=>array('update'),'visible'=>Yii::app()->user->checkAccess('settings.setting.Update')),
						array('label'=>Yii::t('label','View Settings'),'linkOptions'=>array('class'=>'current'), 'id'=>$model->fName,'url'=>array('view'),'visible'=>Yii::app()->user->checkAccess('settings.setting.View')),
