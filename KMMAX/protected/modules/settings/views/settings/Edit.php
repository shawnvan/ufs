...
$form = $this->beginWidget ( 'CActiveForm', array ('action'=>array('settings/saveNewParam'),'id' => 'fSaveNewParam','enableAjaxValidation' => false,
...
?>
    ...
    <div id="edit-form">
		...
		<tr>
				<dl>
					...
					<dt class="field switch" id='User_fIsActive'>
						...
						<input type="hidden" value="1" name="Settings[fVisible]" id="hide_fIsActive" />
					</dt>
       ...
       <tr>
			<td>
				<dl>
					<dd><?php echo $form->labelEx($param,'fGroupName'); ?></dd>
					<dt><?php echo $form->textField($param,'fGroupName'); ?></dt>					
				</dl>
				<?php echo $form->error($param,'fGroupName'); ?>
			</td>
        </tr>
        <tr>
			<td>
				<dl>
					<dd><?php echo $form->labelEx($param,'fModule'); ?></dd>
					<dt>
					
				<?php echo $form->dropDownList($param,'fModule', $modules); ?></dt>					
				</dl>
				<?php echo $form->error($param,'fModule'); ?>
			</td>
        </tr>
