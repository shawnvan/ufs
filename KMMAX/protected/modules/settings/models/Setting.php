...
class Setting extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('fSequence, fVisiBle', 'numerical', 'integerOnly'=>true),
			...
			array('fName, fLabel, fValue, fDescription, fGroupName, fSequence, fVisiBle, fModule', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'fVisiBle' => Yii::t('model','F Visi Ble'),
