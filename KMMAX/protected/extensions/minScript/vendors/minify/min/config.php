 ...
 */
if($this -> minScriptComponent -> minScriptDebug === true) {
...
{
	// Path to minScript cache folder
	$minScriptCachePath = $this -> minScriptComponent -> minScriptRuntimePath . '/cache';
	// Initialize cache folder
	$this -> minScriptComponent -> minScriptInitDir($minScriptCachePath);
	// Set minScript cache folder
    $min_cachePath = $minScriptCachePath;
}
 ...
 */
$min_documentRoot = $this -> minScriptComponent -> minScriptGetPath('/');
