...
class Yii extends YiiBase
{
	...
	/**
	 * Extends {@link YiiBase::createWebApplication()} to use AppWebApplication
	 * @param mixed $config application configuration.
	 * @return AppWebApplication
	 */
	public static function createWebApplication($config=null) {
		require('protected/components/AppWebApplication.php');
		return parent::createApplication('AppWebApplication',$config);
	}
